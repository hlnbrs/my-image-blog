...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Hélène Barroso, agent immobilier Toulouse" },
      {
        name: "description",
        content:
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2">
          <div>
            ...
            <div className="mt-10 space-y-4 text-graphite">
              <a href="tel:+33000000000" className="flex items-center gap-3 hover:text-cerisier">
                <Phone size={18} className="text-argile" /> 06 00 00 00 00
              </a>
            ...
            <img src={IMG.aProposPP} alt="Hélène Barroso" className="mt-10 h-72 w-full object-cover md:hidden" />
          </div>
