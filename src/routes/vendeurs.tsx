    ...
    <Layout>
        ...
        <div className="mx-auto max-w-5xl px-6 py-20">
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-3">
            {[
              ...
              { n: "02", t: "Une seule diffusion", d: "Je publie une seule fois. Pas de surenchère ni de dévalorisation par multi-diffusion." },
      ...
      <section className="bg-creme">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:grid-cols-2 md:items-center">
          <img src={IMG.vendeurAlt} alt="Lecture du dossier acquéreur" className="h-[420px] w-full object-cover" />
          <div>
